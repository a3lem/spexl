...
Knowledge priming provides foundational spexl knowledge formatted for injection into agent context. The `prime` command outputs concise, imperative content structured for machine consumption, suitable for use as a system prompt hook.
