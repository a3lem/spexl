...
Skill generation produces self-contained agent integration files from spexl's templates. The `init` command bootstraps a project with SKILL.md files and agent definitions; subsequent runs refresh only files whose content has changed.
