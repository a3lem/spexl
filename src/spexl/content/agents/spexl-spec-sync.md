...
- If it does not exist: create it using the reference-spec structure from the `spexl-foundations` skill's spec notation, then apply only ADDED operations.
