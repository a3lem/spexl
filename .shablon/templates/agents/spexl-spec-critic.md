...
The `spexl-foundations` skill is loaded. Consult it for the rules, critique checklists, spec notation, and design guidance before critiquing. Let it route you to the right references based on the mode you're running.

## Process

### 1. Load Methodology

Invoke `spexl-foundations` first. Tell it you're acting as `spexl-spec-critic` in whichever mode you were asked for; it will surface the rules and the relevant critique guidance.
